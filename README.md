...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-media-assistant-api?sort=semver)](https://github.com/liberusoftware/module-cms-media-assistant-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-media-assistant-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-media-assistant-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-media-assistant-api
```
...
<a href="https://github.com/liberusoftware/module-cms-media-assistant-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-media-assistant-api" alt="Contributors to liberusoftware/module-cms-media-assistant-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-media-assistant-api/graphs/contributors).
